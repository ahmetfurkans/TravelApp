...
class ViewPagerAdapter (private val travelCategoryList: ArrayList<List<TravelModel>>) : RecyclerView.Adapter<ViewPagerAdapter.ViewPagerViewHolder>() {
    class ViewPagerViewHolder(private val binding: FragmentHomeTabLayoutItemBinding, private val context: Context) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewPagerViewHolder {
        val binding =
            FragmentHomeTabLayoutItemBinding .inflate(LayoutInflater.from(parent.context), parent, false)
